...
def scan_network(ip_range):
    ...
    for host in nm.all_hosts():
        ...
        # Adiciona o dispositivo à lista apenas se o fabricante for Cisco
        if "Cisco" in vendor:
            hosts_info.append({
                'ip': host,
                'mac': mac, 
...
if __name__ == "__main__":
    ...
    # Exibe a quantidade de dispositivos Cisco encontrados
    print(f"Quantidade de dispositivos Cisco encontrados: {len(hosts)}")
